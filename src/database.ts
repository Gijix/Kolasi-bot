...
export class GuildDb {
  ...
  async updateGuild (data: Prisma.GuildUpdateInput) {
  ...
  get jailOptions() {
    return {
      jailId: this.guildInfo.jailId,
      jailRoleId: this.guildInfo.jailRoleId,
      toDeleteRoleId: this.guildInfo.toDeleteRoleId,
    }
  }
}
